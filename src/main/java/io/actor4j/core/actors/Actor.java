...
public abstract class Actor implements ActorRef {
    ...
    /**
     * Don't create here, new actors as child or send messages to other actors.
     * You will get a NullPointerException, because the variable cell is not
     * initialized. It will injected later by the framework. Use instead the
     * method preStart for these reasons.
     */
    public Actor() {
        this(null);
    }
    ...
    /**
     * Gets the children cells
     * @return the list of child cells
     */
    ...
    /**
     * 
     * @return true if the cell is the root, false otherwise
     */
    ...
    /**
     * 
     * @return true if the cell is the root in User, false otherwise
     */
    ...
    /**
     * Initialize here, your actor code. Create new actors as child or send too
     * other actors messages, before the first message for this actor could be
     * processed.
     */
