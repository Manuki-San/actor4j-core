...
public class PodSystemConfiguration {
    ...
    public PodSystemConfiguration(List<String> primaryShardIds, List<String> secondaryShardIds, List<Integer> secondaryShardCounts, int currentShardCount, int currentReplicaCount) {
        super();
